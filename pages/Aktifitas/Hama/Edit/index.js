    ...
    <Layout>
        <div className="w-full">
            ...
            <div className = "grid bg-white rounded-lg shadow pt-5 pb-10 mt-8" >
                <span className="flex justify-center font-medium text-lg pb-5 capitalize">edit data aktifitas pencatatan hama</span>
                <div className='grid md:grid-cols-3 gap-3 md:gap-8 mt-2 sm:px-3 mx-5'>
                    ...
                    <div>
                        ...
                        <Select kategori={[{name: "belalang"}, {name: "tikus"}, {name: "ulat"}, {name: "tungau"}]}/>
                    </div>
                    <div>
                        <Label title="nama kebun"/>
                        <Select kategori={[{name: "stroberi"}, {name: "kelapa sawit"}, {name: "durian"}, {name: "cabe rawit"}]}/>
                    </div>
                    <div>
                        <Label title="blok"/>
                    ...
                    <div>
                        ...
                        <Select kategori={[{name: "sangat besar"}, {name: "besar"}, {name: "sedang"}, {name: "kecil"}]}/>
                    </div>
                    <div>
