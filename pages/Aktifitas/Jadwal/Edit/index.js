    ...
    <Layout>
        <div className='w-full'>
            ...
            <div className='grid bg-white rounded-lg shadow pt-5 pb-24 mt-8'>
                <span className='flex justify-center font-medium text-lg pb-5 capitalize'>edit data jadwal pengecekan</span>
